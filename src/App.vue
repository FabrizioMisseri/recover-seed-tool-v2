...
<template>
  <header>
    <h1 class="pe-5">
      Inserisci i numeri per estrarre il seed
    </h1>
  </header>
  ...
  <main class="container mb-5">
    <div class="row">
      ...
      <div class="offset-2 col-6">
        <input placeholder="inserisci un numero" class="form-control d-inline-block" type="number" id="input-num" min="0"
          max="2047" @keyup.enter="generateInputWord()">
      </div>
      <!-- input numerico -->

      <!-- button -->
      <div class="col-2">
        <div id="output-btn" class="btn btn-danger" @click="generateInputWord()">
          genera parola
        </div>
      </div>
      <!-- button -->
      ...
      <div class="offset-2 col-8 mt-5">
        <ol id="words-list" class="list-group list-group-numbered fs-4 pe-5">
          <!-- debug -->
